...
<body class="flex min-h-screen flex-col bg-gradient-to-b from-amber-50 via-white to-zinc-100 text-zinc-900 antialiased">
    ...
    <footer class="px-4 pb-2 md:px-6 md:pb-4">
        <div class="mx-auto w-full max-w-4xl">
            <flux:card class="gap-3 rounded-3xl border border-amber-200/80 bg-white/80 px-5 py-4 text-sm text-zinc-600 shadow-sm shadow-amber-100 backdrop-blur md:flex-row md:items-center md:justify-between md:px-6">
