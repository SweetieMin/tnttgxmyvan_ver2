                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-4">
                        <div class="xl:col-span-1">
                            <flux:date-picker wire:model.live="catechism_start_date" :label="__('Catechism start date')" locale="vi-VN" />
                        </div>
                        <div class="xl:col-span-1">
                            <flux:date-picker wire:model.live="catechism_end_date" :label="__('Catechism end date')" locale="vi-VN" />
                        </div>
                        <div class="xl:col-span-1">
                            <flux:date-picker wire:model.live="activity_start_date" :label="__('Activity start date')" locale="vi-VN" />
                        </div>
                        <div class="xl:col-span-1">
                            <flux:date-picker wire:model.live="activity_end_date" :label="__('Activity end date')" locale="vi-VN" />
                        </div>
                    </div>
