        ...
        <div class="lg:col-span-3">
            <div class="flex h-full flex-col gap-0 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="flex-1 p-4">
                    <livewire:admin.attendance.attendance-checkins.attendance-checkin-scanner />
                </div>
            </div>
        </div>

        {{-- Right: Scanned list (9/12 width) --}}
        <div class="lg:col-span-9">
            <div class="flex flex-col gap-0 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                <div class="border-b border-zinc-100 px-5 py-4 dark:border-zinc-800">
                    <div class="flex items-center gap-2">
                ...
                <div class="p-4">
                    <livewire:admin.attendance.attendance-checkins.attendance-checkin-list />
                </div>
            </div>
        </div>
    </div>
