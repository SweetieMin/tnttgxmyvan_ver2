<section class="space-y-6">
    <flux:card
        class="overflow-hidden rounded-4xl border border-amber-200/80 bg-white/90 p-0 shadow-sm shadow-amber-100 backdrop-blur">
        <div class="bg-amber-100 px-6 py-8 md:px-10">
